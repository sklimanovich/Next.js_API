                                    ...
                                    <div key={actor.actor_id}>
                                        <div className="bg-white rounded mt-4 p-2">
                                            <ul>
                                                ...
                                                <li>
                                                    <span className="font-semibold">Birthdate: </span><span>{actor.date_of_birth}</span>
                                                </li> 
                                            </ul>
                                        ...
                                        <div onClick={openForm} className="flex justify-end cursor-pointer hover:text-gray-400 mt-5" id="addMovie">
                                            ...
                                            <span className="mx-2 uppercase">Edit actor</span>
                                        </div>
                                            ...
                                            <form onSubmit={validateForm}>
                                                <ul className="flex flex-col justify-end items-end mt-5">
                                                    ...
                                                    <li>
                                                        ...
                                                        hover:text-gray-500 transition ease-out duration-500" onClick={() => setFormId(actor.actor_id)}>Submit</button>
                                                    </li>
                                                </ul>
                                            </form>
                                        </div>
...
export async function getStaticProps(context) {
    ...
    const response = await fetch(`http://localhost:3000/api/actors/${actorId}`)
    const data = await response.json()
